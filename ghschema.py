...
ghschema = sgqlc.types.Schema()


# Unexport Node/PageInfo, let schema re-declare them
ghschema -= sgqlc.types.relay.Node
ghschema -= sgqlc.types.relay.PageInfo
...
class Issue(sgqlc.types.Type, Node, Assignable, Closable, Comment, Deletable, Updatable, UpdatableComment, Labelable, Lockable, Reactable, RepositoryNode, Subscribable, UniformResourceLocatable, ProjectV2Owner):
    __schema__ = ghschema
    __field_names__ = ('body_resource_path', 'body_url', 'comments', 'full_database_id', 'hovercard', 'is_pinned', 'is_read_by_viewer', 'linked_branches', 'milestone', 'number', 'participants', 'project_cards', 'project_items', 'state', 'state_reason', 'timeline', 'timeline_items', 'title', 'title_html', 'tracked_in_issues', 'tracked_issues', 'tracked_issues_count')
...
class ProjectV2View(sgqlc.types.Type, Node):
    __schema__ = ghschema
    __field_names__ = ('created_at', 'database_id', 'fields', 'filter', 'group_by', 'group_by_fields', 'layout', 'name', 'number', 'project', 'sort_by', 'sort_by_fields', 'updated_at', 'vertical_group_by', 'vertical_group_by_fields', 'visible_fields')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
...
class PullRequestReviewComment(sgqlc.types.Type, Node, Comment, Deletable, Minimizable, Updatable, UpdatableComment, Reactable, RepositoryNode):
    __schema__ = ghschema
    __field_names__ = ('commit', 'diff_hunk', 'drafted_at', 'line', 'original_commit', 'original_line', 'original_position', 'original_start_line', 'outdated', 'path', 'position', 'pull_request', 'pull_request_review', 'reply_to', 'resource_path', 'start_line', 'state', 'subject_type', 'url')
    commit = sgqlc.types.Field(Commit, graphql_name='commit')
...
class Sponsorship(sgqlc.types.Type, Node):
    __schema__ = ghschema
    __field_names__ = ('created_at', 'is_active', 'is_one_time_payment', 'is_sponsor_opted_into_email', 'maintainer', 'privacy_level', 'sponsor', 'sponsor_entity', 'sponsorable', 'tier', 'tier_selected_at')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    is_active = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isActive')
...
# Schema Entry Points
########################################################################
ghschema.query_type = Query
ghschema.mutation_type = Mutation
ghschema.subscription_type = None
